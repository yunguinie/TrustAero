...
|---|---|---|---|---:|
| Q01 | PASS | BLOCKED | computed_aggregate_expression, order_by | 4 |
...
Exact IR support: 1/22 (Q06).

Q6 is supported through explicit filters, a temporal range, and one non-nested numeric-product aggregate. No query uses a raw-SQL bypass.
