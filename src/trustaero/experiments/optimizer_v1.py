...
def _report(summary: dict[str, Any]) -> str:
    return (
        ...
        "Median speedup versus fixed late Mask: "
        f"**{summary['median_speedup_vs_fixed_late_percent']:.2f}%**  \n"
        "Median speedup versus fixed early Mask: "
        f"**{summary['median_speedup_vs_fixed_early_percent']:.2f}%**\n\n"
